 ...
 */
import { MAX_CHUNK_CHARS, CONTENT_SELECTORS, EXCLUDE_SELECTORS, CONTENT_CLASS_PATTERNS } from '../constants.js';
import { splitIntoChunks } from '../utils/html-cleaner.js';
...
export class PageTranslator {
   ...
   * @param {Object} controls - The TranslationControls instance
   */
   ...
   * @returns {Array<{originalSection: HTMLElement, content: string}>} Array of section objects
   */
  getContentSections() {
