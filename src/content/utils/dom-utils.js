 ...
 */
export function findClosestMatchingElement(element, selectors) {
  return selectors.reduce((closest, selector) => {
 ...
 */
export function processTextToWords(text) {
 ...
 */
export function hasAnyClass(element, classPatterns) {
